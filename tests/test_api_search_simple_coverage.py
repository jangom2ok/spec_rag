...
class TestSearchAPIMissingCoverage:
    ...
    def test_convert_enhanced_filters_with_all_fields(self):
        ...
        from app.api.search import convert_enhanced_filters_to_legacy, EnhancedFilters
    ...
    async def test_search_documents_missing_coverage(self):
        ...
        from app.api.search import search_documents, SearchRequest, SearchOptions, RankingOptions
    ...
    async def test_search_endpoints_coverage(self):
        ...
        from app.api.search import semantic_search, keyword_search, SearchRequest
        from app.services.hybrid_search_engine import SearchResult
    ...
    async def test_search_aliases_coverage(self):
        ...
        from app.api.search import search_semantic, search_keyword, SearchRequest
