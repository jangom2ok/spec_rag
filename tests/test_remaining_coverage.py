...
class TestSystemAPICoverage:
    ...
    async def test_system_endpoints_exceptions(self):
        ...
        from app.api.system import get_embedding_status, get_search_engine_status
    ...
    async def test_batch_operations_exceptions(self):
        ...
        mock_user = {"permissions": ["admin"]}
        mock_embedding_service = Mock()
        mock_embedding_service.batch_generate_embeddings.side_effect = Exception("Batch error")
